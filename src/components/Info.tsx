...
const Info = () => {
  return (
    <section id="about" className="py-28 md:py-32 bg-neutral-900/80 backdrop-blur-md">
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20">
            ...
            <div className="relative aspect-[4/5] bg-neutral-900/60 overflow-hidden rounded-2xl group">
              <img 
                ...
                src="/aesthetic-project-space/lovable-uploads/a654368f-44f5-42f6-9428-42f7fdeb2886.png" 
